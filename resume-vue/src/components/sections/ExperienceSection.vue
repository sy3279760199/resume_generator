...
const emit = defineEmits(['add-exp', 'remove-exp'])
...
<template>
  <div class="exp">
    ...
    <!-- 列表 -->
    <div class="exp-list">
      <div v-for="(exp, index) in props.experiences" :key="index" class="exp-card">
        ...
        <button class="btn btn-danger" @click="emit('remove-exp', index)">删除</button>
      </div>
    </div>
